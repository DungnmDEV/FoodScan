...
public class BaseRatingBar extends LinearLayout implements SimpleRatingBar {
    ...
    private Drawable m5StarDrawable;
    ...
    private void verifyParamsValue() {
        ...
        if (mEmptyDrawable == null) {
            mEmptyDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_star);
        }

        if (mFilledDrawable == null) {
            mFilledDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_rate_fill);
        }
        ...
        m5StarDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_star);
    ...
    private void initRatingView() {
        ...
        for (int i = 1; i <= mNumStars; i++) {
            ...
            if (i == 5) {
                partialView.setEmptyDrawable(m5StarDrawable);
            }
            addView(partialView);
